...
void parse_go(char* command, Board* board, leaper_moves_masks* leaper_masks, slider_moves_masks* slider_masks); // called when GUI tells engine to calculate moves
